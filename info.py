...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002241178189').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001965914571').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001965914571') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001965914571')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001840476165')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002241178189')).split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'master_hp_raj') # owner username without @
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '-1001928522177') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/KP_MOVIES_DB')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+an1RSS0pWhBlZmM1')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'f22cd8207a831dc26db1e21e5d55572f50cb7ff4')

# Others
MAX_B_TN = environ.get("MAX_B_TN", "5")
PORT = environ.get("PORT", "8080")
MSG_ALRT = environ.get('MSG_ALRT', '𝙹𝚊𝚒 𝚂𝚑𝚛𝚎𝚎 𝚁𝚊𝚖 🙏')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://vj-filter-bot-1-nscj.onrender.com")
